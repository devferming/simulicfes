      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h5><?php echo $info_guia['simul_materia'] ?>: <code>Simulacro #<?php echo $info_guia['simul_orden'] ?> </code></h5>
      ...
      <div class="container-fluid">
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title"><?php echo $result_id2['alum_1er_nombre'].' '.$result_id2['alum_1er_apellido']; ?></h3>
  ...
  <div class="modal fade" id="modal-notasp">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            <small>
                ...
                <strong>
                <span><?php echo $result_id2['alum_1er_nombre'].' '.$result_id2['alum_1er_apellido']; ?></span>
                </strong>
            </small>
          </h5>
        ...
        <form role="form" name="respuestas_simulacro" id="respuestas_simulacro" method="post" action="preifces-modelo.php">
                        ...
                        <div class="card card-warning">
                          ...
                          <div id="collapse1" class="collapse" data-parent="#accordion" >
                            ...
                            for ($i = $ingles_p1; $i <= $ingles_p2; $i++) {
                              ...
                              $respuestar1 = $mat_actual["" . 'p-'.$suma_ingles . ""];
                    ...
                    <div class="card card-primary">
                      ...
                      <div id="collapse2" class="collapse" data-parent="#accordion" >
                        ...
                        for ($i = $naturales_p1; $i <= $naturales_p2; $i++) {
                          ...
                          $respuestar2 = $mat_actual["" . 'p-'.$suma_naturales . ""];
                    ...
                    <div class="card card-secondary">
                      ...
                      <div id="collapse3" class="collapse" data-parent="#accordion" >
                        ...
                        for ($i = $lenguaje_p1; $i <= $lenguaje_p2; $i++) {
                          ...
                          $respuestar3 = $mat_actual["" . 'p-'.$suma_lenguaje . ""];
                    ...
                    <div class="card card-info">
                      ...
                      <div id="collapse4" class="collapse" data-parent="#accordion" >
                        ...
                        for ($i = $matematicas_p1; $i <= $matematicas_p2; $i++) { 
                          ...
                          $respuestar4 = $mat_actual["" . 'p-'.$suma_matematicas . ""];
                    ...
                    <div class="card card-danger">
                      ...
                      <div id="collapse5" class="collapse" data-parent="#accordion" >
                        ...
                        for ($i = $sociales_p1; $i <= $sociales_p2; $i++) {
                          ...
                          $respuestar5 = $mat_actual["" . 'p-'.$suma_sociales . ""];
                    ...
                    <div class="card card-dark">
                      ...
                      <div id="collapse6" class="collapse" data-parent="#accordion" >
                        ...
                        for ($i = $filosofia_p1; $i <= $filosofia_p2; $i++) {
                          ...
                          $respuestar6 = $mat_actual["" . 'p-'.$suma_filosofia . ""];
                    ...
                    <div class="card card-success">
                      ...
                      <div id="collapse7" class="collapse" data-parent="#accordion" >
                        ...
                        for ($i = $fisica_p1; $i <= $fisica_p2; $i++) {
                          ...
                          $respuestar7 = $mat_actual["" . 'p-'.$suma_fisica . ""];
          ...
          <div class="modal-footer justify-content-between">
            ...
            <input type="hidden" name="simul-comando" value="respuestas">
