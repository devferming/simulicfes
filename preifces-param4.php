        ...
        <form role="form" name="guardar-simul" id="guardar-simul" method="post" action="preifces-modelo.php" enctype="multipart/form-data">
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $ingles_dato ?>', '<?php echo $ingles_status ?>');
                      </script>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $naturales_dato ?>', '<?php echo $naturales_status ?>');
                      </script>
                      <div class="invalid-feedback">
                        Este campo es obligatorio.
                      </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $lenguaje_dato ?>', '<?php echo $lenguaje_status ?>');
                      </script>
                      <div class="invalid-feedback">
                        Este campo es obligatorio.
                      </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $matematicas_dato ?>', '<?php echo $matematicas_status ?>');
                      </script>
                      <div class="invalid-feedback">
                        Este campo es obligatorio.
                      </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $sociales_dato ?>', '<?php echo $sociales_status ?>');
                      </script>
                      <div class="invalid-feedback">
                        Este campo es obligatorio.
                      </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $filosofia_dato ?>', '<?php echo $filosofia_status ?>');
                      </script>
                      <div class="invalid-feedback">
                        Este campo es obligatorio.
                      </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <script>
                        buscarSelect2('<?php echo $fisica_dato ?>', '<?php echo $fisica_status ?>');
                      </script>
                      <div class="invalid-feedback">
                        Este campo es obligatorio.
                      </div>
          ...
          <div class="card card-success">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <script>
                      buscarSelect2('simul-tiempo', '<?php echo $simul_tiempo ?>');
                    </script>
                    <div class="invalid-feedback">
                      Este campo es obligatorio.
                    </div>
            ...
            <div class="card-footer">
              ...
              <input type="hidden" name="simul-grado" id="simul-grado" value="<?php echo $cgrado ?>">
