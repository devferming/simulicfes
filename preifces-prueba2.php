              ...
              <div id="accordion">
                <?php
                  if ($result_mat_desc == 'simul_materia_ingles') {
                    ...
                    $mat_actual2 = json_decode($info_guia2["" . $result_mat_desc2 . ""], true);
                    $total_preguntas;
                    $mat_actual_p1 = (int)$mat_actual["" . $mat_p1 . ""];
                    $mat_actual_p2 = (int)$mat_actual["" . $mat_p2 . ""];
                    ?>
                    <div class="card <?php echo $mat_etiqueta ?>">
                      <div class="card-header">
                        <h4 class="card-title w-100">
                    ...
                    $mat_etiqueta = 'card-info';
                    $mat_p1 = 'matematicas_p1';
                    $mat_p2 = 'matematicas_p2';
                    ...
                    $mat_actual_p2 = $mat_actual["" . $mat_p2 . ""];
                    ////////////////////
                    $result_mat_descx3 = 'simul_materia_fisica';
                    $mat_actualx2 = json_decode($info_guia["" . $result_mat_descx3 . ""], true);
                    if ($mat_actualx2['fisica_status'] == 'SI') {
                      $mat_etiquetax2 = 'card-success';
                      $mat_p1x2 = 'fisica_p1';
                      $mat_p2x2 = 'fisica_p2';
                      $result_mat_desc2x2 = 'simulr_fisica';
                      $mat_actual2x2 = json_decode($info_guia2["" . $result_mat_desc2x2 . ""], true);
                      $total_preguntasx2;
                      $mat_actual_p1x2 = $mat_actualx2["" . $mat_p1x2 . ""];
                      $mat_actual_p2x2 = $mat_actualx2["" . $mat_p2x2 . ""];
                      $simul_matx2 = 'Física';
                      ?>
                      <div class="card <?php echo $mat_etiquetax2 ?>">
                        <div class="card-header">
                          <h4 class="card-title w-100">
                            <a class="d-block w-100 collapsed" data-toggle="collapse" href="#collapse2" aria-expanded="false">
                            <span><i class="fas fa-pencil-alt"></i><?php echo $simul_matx2; ?><strong id="#"></strong></span>
                            </a>
                          </h4>
                        </div>
                        <div id="collapse2" class="collapse" data-parent="#accordion" >
                          <div class="card-body" id="#respuestas-ingles">
                            ...
                            <?php
                            $suma_matx2 = $mat_actual_p1x2;
                            for ($i = $mat_actual_p1x2; $i <= $mat_actual_p2x2; $i++) {
                              
                              $respuestarx2 = $mat_actual2x2["" . 'p-'.$suma_matx2 . ""];
                              $respuestatx2 = $mat_actual2x2["" . 'pt-'.$suma_matx2 . ""];
                              $respuestacx2 = $mat_actual2x2["" . 'pc-'.$suma_matx2 . ""];
                              ...
                              <div class="col-sm-12">
                                <div class="form-group">
                                  <div class="input-group">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text"><?php echo $suma_matx2 ?></span>
                                    </div>
                                      <select class="form-control bloquear" name="p-<?php echo $suma_matx2 ?>" id="p-<?php echo $suma_matx2 ?>">
                                        <option value=" " class="seleccionados"></option>
                                        <option value="A" class="seleccionados">A</option>
                                        <option value="B" class="seleccionados">B</option>
                                        <option value="C" class="seleccionados">C</option>
                              ...
                              <script>
                                ...
                                {
                                  // creamos un variable que hace referencia al select
                                  var select=document.getElementById('p-<?php echo $suma_matx2 ?>');
                                
                                  // obtenemos el valor a buscar
                                  var buscar='<?php echo $respuestarx2 ?>';
                              ...
                              <div class="col-sm-12">
                                <div class="form-group">
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control direccion" name="pt-<?php echo $suma_matx2 ?>" id="pt-<?php echo $suma_matx2 ?>" placeholder="Tema: P-<?php echo $suma_matx2 ?>" autocomplete="off" value="<?php echo $respuestatx2 ?>">
                                    <div class="invalid-feedback">
                                      Este campo es obligatorio.
                                    </div>                   
                                  </div>
                              ...
                              <div class="col-sm-12">
                                <div class="form-group">
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control direccion" name="pc-<?php echo $suma_matx2 ?>" id="pc-<?php echo $suma_matx2 ?>" placeholder="Componente: P-<?php echo $suma_matx2 ?>" autocomplete="off" value="<?php echo $respuestacx2 ?>">
                                    <div class="invalid-feedback">
                                      Este campo es obligatorio.
                                    </div>                   
                                  </div>
                      ...
                      <input type="hidden" name="fisica_status" id="fisica_status" value="SI">
                      <input type="hidden" name="simul_p1x2" id="simul_p1x2" value="<?php echo $mat_actual_p1x2 ?>">
                      <input type="hidden" name="simul_p2x2" id="simul_p2x2" value="<?php echo $mat_actual_p2x2 ?>">    
                      <?php
                    } //Condicional en caso de que la materia Física tenga status = SI
                    ?>
                    <div class="card <?php echo $mat_etiqueta ?>">
                      <div class="card-header">
                        <h4 class="card-title w-100">
                    ...
                    $mat_actual_p2 = $mat_actual["" . $mat_p2 . ""];
                    /////////////////////
                    $result_mat_descx3 = 'simul_materia_filosofia';
                    $mat_actualx2 = json_decode($info_guia["" . $result_mat_descx3 . ""], true);
                    if ($mat_actualx2['filosofia_status'] == 'SI') {
                      $mat_etiquetax2 = 'card-dark';
                      $mat_p1x2 = 'filosofia_p1';
                      $mat_p2x2 = 'filosofia_p2';
                      $result_mat_desc2x2 = 'simulr_filosofia';
                      $mat_actual2x2 = json_decode($info_guia2["" . $result_mat_desc2x2 . ""], true);
                      $total_preguntasx2;
                      $mat_actual_p1x2 = $mat_actualx2["" . $mat_p1x2 . ""];
                      $mat_actual_p2x2 = $mat_actualx2["" . $mat_p2x2 . ""];
                      $simul_matx2 = 'Filosofia';
                      ?>
                      <div class="card <?php echo $mat_etiquetax2 ?>">
                        <div class="card-header">
                          <h4 class="card-title w-100">
                      ...
                      <input type="hidden" name="filosofia_status" id="filosofia_status" value="SI">
                      <input type="hidden" name="simul_p1x2" id="simul_p1x2" value="<?php echo $mat_actual_p1x2 ?>">
                      <input type="hidden" name="simul_p2x2" id="simul_p2x2" value="<?php echo $mat_actual_p2x2 ?>">    
                      <?php
                    } //Condicional en caso de que la materia Física tenga status = SI
