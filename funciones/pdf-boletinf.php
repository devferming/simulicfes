<?php
    ...
    try {
        ...
        $stmt->bind_param("iss", $id, $mat_1, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        $nota_per2 = number_format( (float) $datosp2['notas_des'], 1, '.', '');
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_1 = ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    try {
        ...
        $resultadop3 = $stmt->get_result();
        $datosp3 = $resultadop3->fetch_assoc();
        $stmt->bind_param("iss", $id, $mat_2, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        ...
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_2 = ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    if ($alum_grado == 'PRIMERO' || $alum_grado == 'SEGUNDO' || $alum_grado == 'TERCERO' || $alum_grado == 'CUARTO' || $alum_grado == 'QUINTO') {
        ...
        try {
            ...
            $resultadop3 = $stmt->get_result();
            $datosp3 = $resultadop3->fetch_assoc();
            $stmt->bind_param("iss", $id, $mat_3, $nota_p4);
            $stmt->execute();
            $resultadop4 = $stmt->get_result();
            $datosp4 = $resultadop4->fetch_assoc();
            ...
            $nota_final_mat_3 = ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    try {
        ...
        $resultadop3 = $stmt->get_result();
        $datosp3 = $resultadop3->fetch_assoc();
        $stmt->bind_param("iss", $id, $mat_4, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        ...
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_4 = ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    try {
        ...
        $resultadop3 = $stmt->get_result();
        $datosp3 = $resultadop3->fetch_assoc();
        $stmt->bind_param("iss", $id, $mat_5, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        ...
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_5 = ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    try {
        ...
        $resultadop3 = $stmt->get_result();
        $datosp3 = $resultadop3->fetch_assoc();
        $stmt->bind_param("iss", $id, $mat_6, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        ...
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_6 = ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    try {
        ...
        $resultadop3 = $stmt->get_result();
        $datosp3 = $resultadop3->fetch_assoc();
        $stmt->bind_param("iss", $id, $mat_7, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        ...
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_7= ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
    ...
    try {
        ...
        $resultadop3 = $stmt->get_result();
        $datosp3 = $resultadop3->fetch_assoc();
        $stmt->bind_param("iss", $id, $mat_8, $nota_p4);
        $stmt->execute();
        $resultadop4 = $stmt->get_result();
        $datosp4 = $resultadop4->fetch_assoc();
        $nota_per1 = number_format( (float) $datosp1['notas_des'], 1, '.', '');
        ...
        $nota_per3 = number_format( (float) $datosp3['notas_des'], 1, '.', '');
        $nota_per4 = number_format( (float) $datosp4['notas_des'], 1, '.', '');
        $nota_final_mat_8= ($nota_per1 + $nota_per2 + $nota_per3 + $nota_per4) / 4;
