    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-success">
          ...
          $fecha_actual = date("m/d/Y h:i A"); //h:i A

          $status_fecha_dt = DateTime::createFromFormat('m/d/Y h:i A', $status_fecha);
          $fecha_actual_dt = DateTime::createFromFormat('m/d/Y h:i A', $fecha_actual);
          ...
          <div class="card-footer">
            ...
            if ($nac_fec1 == $hoy) {
              ...
              if (!is_null($status_fecha)) {
                ...
                if ($status_fecha_dt > $fecha_actual_dt) { ?>
